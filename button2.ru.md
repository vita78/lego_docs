...
Поле | Тип | Описание
--- | --- | ---
[text](#Работа-с-текстом) | `String` | Текст кнопки (не путать с полем `content`). 
...
[icon](#Работа-с-иконками) | `BEMJSON` | Иконка кнопки. Рекомендуется для использования без текста. Формируется блоком [icon](#). 
